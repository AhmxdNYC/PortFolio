...
const Navbar = ({ scrollToSection, introRef }) => {
  ...
  return (
    ...
    <div
      ...
      } fixed top-0 left-0 w-full z-50  py-4 bg-opacity-80 flex`}
    >
      <img
        onClick={() => scrollToSection(introRef)}
        src="./Port.png"
        className=" absolute w-[2.9rem] scale-150 left-[32rem] bottom-[1.1rem] cursor-pointer"
        alt=""
      />
      <nav className="flex justify-center space-x-5 mx-auto rounded-full border border-[#939393] w-[18rem] p-3 "
      >
        <div
        ...
        <button onClick={toggleVision}>
          {toggleMode ? (
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="size-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-1"
            >
              <path
